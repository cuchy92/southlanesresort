<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("resolveIssue");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid resolveIssue");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: SeminarRegistration.ResolveIssue
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">resolveIssue</label>
                            		<div class="div_checkbox">
                              		<input name="resolveIssue" type="checkbox" class="checkbox" id="resolveIssue" value="${resolveIssue}" />
                            		</div>
