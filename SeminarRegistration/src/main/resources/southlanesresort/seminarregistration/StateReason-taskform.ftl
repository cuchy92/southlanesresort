<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("reason");
					i++;
...
<div id="container">
	<div id="header">
		User Task Form: SeminarRegistration.StateReason
	</div>
	<div id="content">
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="reason" type="text" class="textbox" id="reason" value="${reason}" />
                            		</div>
